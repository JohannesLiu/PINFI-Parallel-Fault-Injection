...
define i32 @crc32file(i8* %name, i64* %crc, i64* %charcnt) #0 {
  ...
  %7 = load i8** %2, align 8, !llfi_index !29
  %8 = load i8** %2, align 8, !llfi_index !29
  call void bitcast (void (i64, i64)* @global_add to void (i8*, i8*)*)(i8* %7, i8* %8)
  %9 = call %struct._IO_FILE* @fopen(i8* %7, i8* getelementptr inbounds ([2 x i8]* @.str, i32 0, i32 0)), !llfi_index !30
  store %struct._IO_FILE* %9, %struct._IO_FILE** %fin, align 8, !llfi_index !31
  %10 = icmp eq %struct._IO_FILE* %9, null, !llfi_index !32
  %11 = icmp eq %struct._IO_FILE* %9, null, !llfi_index !32
  call void bitcast (void (i64, i64)* @global_add to void (i1, i1)*)(i1 %10, i1 %11)
  br i1 %10, label %12, label %15, !llfi_index !33

; <label>:12                                      ; preds = %0
  %13 = load i8** %2, align 8, !llfi_index !34
  %14 = load i8** %2, align 8, !llfi_index !34
  call void bitcast (void (i64, i64)* @global_add to void (i8*, i8*)*)(i8* %13, i8* %14)
  call void @perror(i8* %13), !llfi_index !35
  store i32 -1, i32* %1, !llfi_index !36
  br label %72, !llfi_index !37

; <label>:15                                      ; preds = %0
  br label %16, !llfi_index !38

; <label>:16                                      ; preds = %22, %15
  %17 = load %struct._IO_FILE** %fin, align 8, !llfi_index !39
  %18 = load %struct._IO_FILE** %fin, align 8, !llfi_index !39
  call void bitcast (void (i64, i64)* @global_add to void (%struct._IO_FILE*, %struct._IO_FILE*)*)(%struct._IO_FILE* %17, %struct._IO_FILE* %18)
  %19 = call i32 @_IO_getc(%struct._IO_FILE* %17), !llfi_index !40
  store i32 %19, i32* %c, align 4, !llfi_index !41
  %20 = icmp ne i32 %19, -1, !llfi_index !42
  %21 = icmp ne i32 %19, -1, !llfi_index !42
  call void bitcast (void (i64, i64)* @global_add to void (i1, i1)*)(i1 %20, i1 %21)
  br i1 %20, label %22, label %51, !llfi_index !43

; <label>:22                                      ; preds = %16
  %23 = load i64** %4, align 8, !llfi_index !44
  %24 = load i64** %4, align 8, !llfi_index !44
  %25 = load i64* %23, align 8, !llfi_index !45
  %26 = load i64* %24, align 8, !llfi_index !45
  %27 = add nsw i64 %25, 1, !llfi_index !46
  %28 = add nsw i64 %26, 1, !llfi_index !46
  call void @global_add(i64 %27, i64 %28)
  store i64 %27, i64* %23, align 8, !llfi_index !47
  %29 = load i64* %oldcrc32, align 8, !llfi_index !48
  %30 = load i64* %oldcrc32, align 8, !llfi_index !48
  %31 = load i32* %c, align 4, !llfi_index !49
  %32 = load i32* %c, align 4, !llfi_index !49
  %33 = trunc i32 %31 to i8, !llfi_index !50
  %34 = trunc i32 %32 to i8, !llfi_index !50
  %35 = zext i8 %33 to i64, !llfi_index !51
  %36 = zext i8 %34 to i64, !llfi_index !51
  %37 = xor i64 %29, %35, !llfi_index !52
  %38 = xor i64 %30, %36, !llfi_index !52
  %39 = and i64 %37, 255, !llfi_index !53
  %40 = and i64 %38, 255, !llfi_index !53
  %41 = getelementptr inbounds [256 x i64]* @crc_32_tab, i32 0, i64 %39, !llfi_index !54
  %42 = getelementptr inbounds [256 x i64]* @crc_32_tab, i32 0, i64 %40, !llfi_index !54
  %43 = load i64* %41, align 8, !llfi_index !55
  %44 = load i64* %42, align 8, !llfi_index !55
  %45 = load i64* %oldcrc32, align 8, !llfi_index !56
  %46 = load i64* %oldcrc32, align 8, !llfi_index !56
  %47 = lshr i64 %45, 8, !llfi_index !57
  %48 = lshr i64 %46, 8, !llfi_index !57
  %49 = xor i64 %43, %47, !llfi_index !58
  %50 = xor i64 %44, %48, !llfi_index !58
  call void @global_add(i64 %49, i64 %50)
  store i64 %49, i64* %oldcrc32, align 8, !llfi_index !59
  br label %16, !llfi_index !60

; <label>:51                                      ; preds = %16
  %52 = load %struct._IO_FILE** %fin, align 8, !llfi_index !61
  %53 = load %struct._IO_FILE** %fin, align 8, !llfi_index !61
  call void bitcast (void (i64, i64)* @global_add to void (%struct._IO_FILE*, %struct._IO_FILE*)*)(%struct._IO_FILE* %52, %struct._IO_FILE* %53)
  %54 = call i32 @ferror(%struct._IO_FILE* %52) #4, !llfi_index !62
  %55 = icmp ne i32 %54, 0, !llfi_index !63
  %56 = icmp ne i32 %54, 0, !llfi_index !63
  call void bitcast (void (i64, i64)* @global_add to void (i1, i1)*)(i1 %55, i1 %56)
  br i1 %55, label %57, label %62, !llfi_index !64

; <label>:57                                      ; preds = %51
  %58 = load i8** %2, align 8, !llfi_index !65
  %59 = load i8** %2, align 8, !llfi_index !65
  call void bitcast (void (i64, i64)* @global_add to void (i8*, i8*)*)(i8* %58, i8* %59)
  call void @perror(i8* %58), !llfi_index !66
  %60 = load i64** %4, align 8, !llfi_index !67
  %61 = load i64** %4, align 8, !llfi_index !67
  call void bitcast (void (i64, i64)* @global_add to void (i64*, i64*)*)(i64* %60, i64* %61)
  store i64 -1, i64* %60, align 8, !llfi_index !68
  br label %62, !llfi_index !69

; <label>:62                                      ; preds = %57, %51
  %63 = load %struct._IO_FILE** %fin, align 8, !llfi_index !70
  %64 = load %struct._IO_FILE** %fin, align 8, !llfi_index !70
  call void bitcast (void (i64, i64)* @global_add to void (%struct._IO_FILE*, %struct._IO_FILE*)*)(%struct._IO_FILE* %63, %struct._IO_FILE* %64)
  %65 = call i32 @fclose(%struct._IO_FILE* %63), !llfi_index !71
  %66 = load i64* %oldcrc32, align 8, !llfi_index !72
  %67 = load i64* %oldcrc32, align 8, !llfi_index !72
  %68 = xor i64 %66, -1, !llfi_index !73
  %69 = xor i64 %67, -1, !llfi_index !73
  call void @global_add(i64 %68, i64 %69)
  store i64 %68, i64* %oldcrc32, align 8, !llfi_index !74
  %70 = load i64** %3, align 8, !llfi_index !75
  %71 = load i64** %3, align 8, !llfi_index !75
  call void bitcast (void (i64, i64)* @global_add to void (i64*, i64*)*)(i64* %70, i64* %71)
  store i64 %68, i64* %70, align 8, !llfi_index !76
  store i32 0, i32* %1, !llfi_index !77
  br label %72, !llfi_index !78

; <label>:72                                      ; preds = %62, %12
  %73 = load i32* %1, !llfi_index !79
  %74 = load i32* %1, !llfi_index !79
  call void bitcast (void (i64, i64)* @global_add to void (i32, i32)*)(i32 %73, i32 %74)
  ret i32 %73, !llfi_index !80
}
...
; <label>:3                                       ; preds = %31, %0
  ...
  br i1 %6, label %8, label %40, !llfi_index !90

; <label>:8                                       ; preds = %3
  %9 = load i64* %oldcrc32, align 8, !llfi_index !91
  %10 = load i64* %oldcrc32, align 8, !llfi_index !91
  %11 = load i8** %1, align 8, !llfi_index !92
  %12 = load i8** %1, align 8, !llfi_index !92
  %13 = load i8* %11, align 1, !llfi_index !93
  %14 = load i8* %12, align 1, !llfi_index !93
  %15 = zext i8 %13 to i64, !llfi_index !94
  %16 = zext i8 %14 to i64, !llfi_index !94
  %17 = xor i64 %9, %15, !llfi_index !95
  %18 = xor i64 %10, %16, !llfi_index !95
  %19 = and i64 %17, 255, !llfi_index !96
  %20 = and i64 %18, 255, !llfi_index !96
  %21 = getelementptr inbounds [256 x i64]* @crc_32_tab, i32 0, i64 %19, !llfi_index !97
  %22 = getelementptr inbounds [256 x i64]* @crc_32_tab, i32 0, i64 %20, !llfi_index !97
  %23 = load i64* %21, align 8, !llfi_index !98
  %24 = load i64* %22, align 8, !llfi_index !98
  %25 = load i64* %oldcrc32, align 8, !llfi_index !99
  %26 = load i64* %oldcrc32, align 8, !llfi_index !99
  %27 = lshr i64 %25, 8, !llfi_index !100
  %28 = lshr i64 %26, 8, !llfi_index !100
  %29 = xor i64 %23, %27, !llfi_index !101
  %30 = xor i64 %24, %28, !llfi_index !101
  call void @global_add(i64 %29, i64 %30)
  store i64 %29, i64* %oldcrc32, align 8, !llfi_index !102
  br label %31, !llfi_index !103

; <label>:31                                      ; preds = %8
  %32 = load i64* %2, align 8, !llfi_index !104
  %33 = load i64* %2, align 8, !llfi_index !104
  %34 = add i64 %32, -1, !llfi_index !105
  %35 = add i64 %33, -1, !llfi_index !105
  call void @global_add(i64 %34, i64 %35)
  store i64 %34, i64* %2, align 8, !llfi_index !106
  %36 = load i8** %1, align 8, !llfi_index !107
  %37 = load i8** %1, align 8, !llfi_index !107
  %38 = getelementptr inbounds i8* %36, i32 1, !llfi_index !108
  %39 = getelementptr inbounds i8* %37, i32 1, !llfi_index !108
  call void bitcast (void (i64, i64)* @global_add to void (i8*, i8*)*)(i8* %38, i8* %39)
  store i8* %38, i8** %1, align 8, !llfi_index !109
  br label %3, !llfi_index !110

; <label>:40                                      ; preds = %3
  %41 = load i64* %oldcrc32, align 8, !llfi_index !111
  %42 = load i64* %oldcrc32, align 8, !llfi_index !111
  %43 = xor i64 %41, -1, !llfi_index !112
  %44 = xor i64 %42, -1, !llfi_index !112
  call void @global_add(i64 %43, i64 %44)
  ret i64 %43, !llfi_index !113
}
...
; <label>:4                                       ; preds = %11, %0
  ...
  br i1 %9, label %11, label %32, !llfi_index !129

; <label>:11                                      ; preds = %4
  %12 = load i8*** %3, align 8, !llfi_index !130
  %13 = load i8*** %3, align 8, !llfi_index !130
  %14 = getelementptr inbounds i8** %12, i32 1, !llfi_index !131
  %15 = getelementptr inbounds i8** %13, i32 1, !llfi_index !131
  store i8** %14, i8*** %3, align 8, !llfi_index !132
  %16 = load i8** %14, align 8, !llfi_index !133
  %17 = load i8** %15, align 8, !llfi_index !133
  call void bitcast (void (i64, i64)* @global_add to void (i8*, i8*)*)(i8* %16, i8* %17)
  %18 = call i32 @crc32file(i8* %16, i64* %crc, i64* %charcnt), !llfi_index !134
  %19 = load i32* %errors, align 4, !llfi_index !135
  %20 = load i32* %errors, align 4, !llfi_index !135
  %21 = or i32 %19, %18, !llfi_index !136
  %22 = or i32 %20, %18, !llfi_index !136
  call void bitcast (void (i64, i64)* @global_add to void (i32, i32)*)(i32 %21, i32 %22)
  store i32 %21, i32* %errors, align 4, !llfi_index !137
  %23 = load i64* %crc, align 8, !llfi_index !138
  %24 = load i64* %crc, align 8, !llfi_index !138
  call void @global_add(i64 %23, i64 %24)
  %25 = load i64* %charcnt, align 8, !llfi_index !139
  %26 = load i64* %charcnt, align 8, !llfi_index !139
  call void @global_add(i64 %25, i64 %26)
  %27 = load i8*** %3, align 8, !llfi_index !140
  %28 = load i8*** %3, align 8, !llfi_index !140
  %29 = load i8** %27, align 8, !llfi_index !141
  %30 = load i8** %28, align 8, !llfi_index !141
  call void bitcast (void (i64, i64)* @global_add to void (i8*, i8*)*)(i8* %29, i8* %30)
  %31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([15 x i8]* @.str1, i32 0, i32 0), i64 %23, i64 %25, i8* %29), !llfi_index !142
  br label %4, !llfi_index !143

; <label>:32                                      ; preds = %4
  %33 = load i32* %errors, align 4, !llfi_index !144
  %34 = load i32* %errors, align 4, !llfi_index !144
  %35 = icmp ne i32 %33, 0, !llfi_index !145
  %36 = icmp ne i32 %34, 0, !llfi_index !145
  %37 = zext i1 %35 to i32, !llfi_index !146
  %38 = zext i1 %36 to i32, !llfi_index !146
  call void bitcast (void (i64, i64)* @global_add to void (i32, i32)*)(i32 %37, i32 %38)
  call void @global_check()
  ret i32 %37, !llfi_index !147
}
